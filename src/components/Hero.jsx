...
export default function Hero() {
  ...
  const marqueeClients = [...heroClients, ...heroClients, ...heroClients];
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      const scrollDistance = Math.max(rect.height * 0.62, 1);
  ...
  return (
    <section className="hero" ref={heroRef}>
      <div className="container hero-content">
        ...
        <h1>
          Editing <span className="serif">stories</span> for{' '}
          <span className="platform-icons">
            ...
            <span className="platform-icon" title="TikTok">
          ...
          that <span className="serif">convert</span>.
        </h1>
        ...
        <div className="hero-clients-row">
          <div className="hero-clients-track">
            {marqueeClients.map((c, i) => (
              <span className="hero-client-item" key={`${c}-${i}`}>
                <span>{c}</span>
